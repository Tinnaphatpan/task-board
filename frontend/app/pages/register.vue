  ...
  <div class="min-h-screen bg-gray-950 flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-400 mt-2">สร้างบัญชีใหม่</p>
      </div>

      <div class="bg-gray-900 rounded-2xl p-8 border border-gray-800">
        <form @submit.prevent="handleRegister" class="space-y-5">
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1.5">ชื่อ-นามสกุล</label>
            <input
        ...
        <p class="text-center text-gray-500 text-sm mt-6">
          มีบัญชีอยู่แล้ว?
          <NuxtLink to="/login" class="text-indigo-400 hover:text-indigo-300 transition">เข้าสู่ระบบ</NuxtLink>
        </p>
      </div>
    </div>
  </div>
